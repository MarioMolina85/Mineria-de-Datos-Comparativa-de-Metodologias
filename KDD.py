...
st.set_page_config(page_title="Proyecto KDD", layout="wide")

st.title("Proyecto KDD con Datos de Estudiantes")

st.markdown("## 1. Seleccion datos o Set datos")
st.write("""
...
if archivo1 and archivo2:
    ...
    st.markdown("## 2. Procesamiento de los Datos")
    ...
    st.markdown("## 4. Transformacion de Datos")
    ...
    st.markdown("## 5. Mineria de datos")
    ...
    st.markdown("## 6. Evaluación e Iterpretacion del Modelo")
