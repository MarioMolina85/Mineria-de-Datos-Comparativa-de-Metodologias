...
st.set_page_config(page_title="Proyecto SEMMA", layout="wide")

st.title("Proyecto SEMMA con Datos de Estudiantes")

st.markdown("## 1. Muestra o Seleccion de la Data")
st.write("""
...
if archivo1 and archivo2:
    ...
    st.markdown("## 2. EXPLIRAR LOS DATOS")
    ...
    st.markdown("## 3. Visualización de Exploracion")
    ...
    st.markdown("## 4.Modificar o Preparación de Datos")
    ...
    st.markdown("## 5. Modelado o Seleccion de Algoritmo")
    ...
    st.markdown("## 6. Evaluación del Modelo")
